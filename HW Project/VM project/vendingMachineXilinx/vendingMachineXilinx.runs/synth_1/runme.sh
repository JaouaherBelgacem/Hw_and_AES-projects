...
HD_PWD='C:/Users/ACER/Desktop/vending machine v2/VendingM/VendingM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VendingM.tcl
