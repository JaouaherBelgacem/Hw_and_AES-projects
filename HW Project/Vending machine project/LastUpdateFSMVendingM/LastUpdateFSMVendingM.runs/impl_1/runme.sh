...
HD_PWD='C:/Users/ACER/Desktop/vending machine v2/VendingM/VendingM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VendingM.tcl -notrace
